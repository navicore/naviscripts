return {
  {
    url = "https://git.navicore.tech/navicore/patch-rexx.nvim",
    ft = "rexx",
    opts = {
    ...
    opts = {
      on_attach = function(_, bufnr)
        ...
        vim.keymap.set("n", "<leader>H", function()
          seq_hover.toggle(bufnr)
        end, { buffer = bufnr, noremap = true, silent = true, desc = "Toggle pinned seq hover panel" })
      end,
    },
  },
  {
